...
#             additional_columns_to_remove.append('SURG_DISCHARGE_DAYS')
        ...
        df_filtered = filter_columns(df, remove_a_prefix=True, additional_cols_to_remove=additional_columns_to_remove, remove_lowercase=True)
        ...
        if verbose:
            print('Removing treatment-related variables')
        df_filtered = filter_columns(df, remove_a_prefix=False, additional_cols_to_remove=additional_columns_to_remove, remove_lowercase=True)
...
#                   'REG_LN_DISS_STARTED_DAY', # days between initial dx and LN dissection - excluded due to missing values
                  'DX_STAGING_PROC_DAYS', # days between initial dx and surgical staging
...
def model_interpretability(model, X_test, y_test):
